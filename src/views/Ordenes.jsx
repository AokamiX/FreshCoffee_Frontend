    ...
    <div>
        ...
        <div className="grid grid-cols-2 gap-5">
            {data.data.data.map(pedido => (
                <div key={pedido.id} className="flex flex-col justify-between p-5 bg-white shadow space-y-2 border-b">
                    <div>
                        ...
                        {pedido.productos.map(producto => (
                            <div
                                key={producto.id}
                                className="border-b boder-b-slate-200 last-of-type:border-none py-4"
                            >
